...
3. repository variables `AWS_DEPLOY_ROLE_ARN` and `PROD_EC2_INSTANCE_ID` exist.

Without those variables, the workflow is intentionally unarmed and exits without
touching AWS.
